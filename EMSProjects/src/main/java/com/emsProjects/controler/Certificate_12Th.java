...
public class Certificate_12Th {
	@Autowired
	private FileService fileService;
	
	@Value("${projectdo.image}")
	private String path;
	
	@PostMapping("/Certificate_12Th")
	...
	@GetMapping(value = "/Certificate_12Th/{imageName}",produces=MediaType.IMAGE_JPEG_VALUE)
