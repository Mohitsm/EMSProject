...
public class Post_Graduation {
	@Autowired
	private FileService fileService;
	
	@Value("${projectdocu.image}")
	private String path;
	
	@PostMapping("/Post_Graduation")
	...
	@GetMapping(value = "/Post_Graduation/{imageName}",produces=MediaType.IMAGE_JPEG_VALUE)
